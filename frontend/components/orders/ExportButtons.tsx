...
async function exportToPDF(orders: Order[], contextName: string, titleLabel: string) {
  ...
  doc.text("Haji Cafe - Orders Report", 14, 22);

  doc.setFontSize(10);
  doc.setFont("helvetica", "normal");
  doc.setTextColor(100);
  doc.text(titleLabel, 14, 30);
  ...
  doc.save(`haji-cafe-${contextName}-orders.pdf`);
}
  ...
  return (
    <div style={{ display: "flex", gap: 8 }}>
      ...
      <button
        className="btn btn-ghost btn-sm"
        disabled={isDisabled}
        onClick={() => exportToPDF(orders, contextName, titleLabel)}
